...
class Buy(models.Model):
    ...
    creation_date = models.DateTimeField(auto_now_add=True, verbose_name='Fecha y hora de registro')
    date_joined = models.DateField(default=datetime.now, verbose_name='Fecha de registro')
    subtotal_12 = models.DecimalField(max_digits=15, decimal_places=2, default=0.00, verbose_name='Subtotal 12%')
    subtotal_0 = models.DecimalField(max_digits=15, decimal_places=2, default=0.00, verbose_name='Subtotal 0%')
    dscto = models.DecimalField(max_digits=15, decimal_places=2, default=0.00, verbose_name='Descuento')
    total_dscto = models.DecimalField(max_digits=15, decimal_places=2, default=0.00, verbose_name='Valor del descuento')
    iva = models.DecimalField(max_digits=15, decimal_places=2, default=0.00, verbose_name='Iva')
    total_iva = models.DecimalField(max_digits=15, decimal_places=2, default=0.00, verbose_name='Valor de iva')
    total = models.DecimalField(max_digits=15, decimal_places=2, default=0.00, verbose_name='Total a pagar')
    cash = models.DecimalField(max_digits=15, decimal_places=2, default=0.00, verbose_name='Efectivo pagado')
    change = models.DecimalField(max_digits=15, decimal_places=2, default=0.00, verbose_name='Cambio')
    paymentmethod = models.CharField(max_length=50, choices=PAYMENTMETHODS, default=PAYMENTMETHODS[0][0], verbose_name='Método de pago')
    transfermethods = models.CharField(max_length=50, choices=TRANSFERMETHODS, default=TRANSFERMETHODS[0][0], verbose_name='Tipo transferencia', null=True)
    is_active = models.BooleanField(default=True, verbose_name='Estado')
...
class BuyDetail(models.Model):
    ...
    price_with_vat = models.DecimalField(max_digits=15, decimal_places=2, default=0.00)
    subtotal = models.DecimalField(max_digits=15, decimal_places=2, default=0.00)
    iva = models.DecimalField(max_digits=15, decimal_places=2, default=0.00)
    total_iva = models.DecimalField(max_digits=15, decimal_places=2, default=0.00)
    dscto = models.DecimalField(max_digits=15, decimal_places=2, default=0.00)
    total_dscto = models.DecimalField(max_digits=15, decimal_places=2, default=0.00)
